...
const imageUrl = `../public/images/${service._id}.jpg`;

  return (
    <div className="card-service">
        <div key={service._id} className="col-sm-6 col-lg-3 mb-4">
            <div className="card h-100 shadow">
            <div className="card-img-top" style={{ height: '200px', overflow: 'hidden' }}>
                <img 
                // src="https://i.scdn.co/image/ab67616100005174274df4dfcb960867eccedfb5"
                  src={imageUrl}
                // src={`/imagenes/${service._id}.jpg`} 
                alt="Service"
                className="img-fluid" 
            ...
            <div className="card-footer text-center">
                <Link 
                to={isAuthenticated ? `/services/${service._id}` : '/login'}
